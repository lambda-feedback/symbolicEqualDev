FROM ghcr.io/lambda-feedback/evaluation-function-base/python:3.10 AS builder
...
FROM ghcr.io/lambda-feedback/evaluation-function-base/python:3.10
...
# Copy the evaluation function to the evaluation_function directory
